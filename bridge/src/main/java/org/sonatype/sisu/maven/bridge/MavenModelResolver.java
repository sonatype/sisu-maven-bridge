...
public interface MavenModelResolver
{
   ...
   * @since 2.0
   */
  Model resolveModel(ModelBuildingRequest request, RemoteRepository... repositories) throws ModelBuildingException;
   ...
   * @since 2.0
   */
  Model resolveModel(ModelBuildingRequest request, RepositorySystemSession session, RemoteRepository... repositories)
